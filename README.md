...
| `courseid`     | Use the given course as the source context (e.g. to derive the category scope). Accepts an integer course ID or the literal `last`for the current user's most recently accessed course. |
