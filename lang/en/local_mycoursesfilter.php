...
/**
 * Language strings for local_mycoursesfilter.
 *
...
$string['pluginname'] = 'MyCoursesFiltered';
$string['privacy:metadata'] = 'The local my courses filter plugin does not store any personal data of its own.';
$string['privacy:metadata:preference:dir'] = 'The user preference storing the selected sort direction.';
$string['privacy:metadata:preference:filter'] = 'The user preference storing the selected course filter.';
$string['privacy:metadata:preference:sort'] = 'The user preference storing the selected course sorting.';
$string['privacy:metadata:preference:view'] = 'The user preference storing the selected course view.';
